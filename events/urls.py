...
urlpatterns = [
    path("event-category/", EventCategoryListCreateView.as_view(), name="event-category"),
    ...
    path("delete-event/<int:event_id>/", EventDeleteView.as_view(), name="event-delete"),
    path("update-event/<int:event_id>/", EventUpdateView.as_view(), name="event-update"),
    ...
    path("get-events-by-servicer/", views.get_events_by_servicer, name="get-events-by-servicer"),
    path(
        "single-event/<int:id>/", SingleEventDetailView.as_view(), name="single_event_detail"
    ),
    ...
    path("categories/<int:category_id>/", CategoryUpdateDeleteView.as_view(), name="category-update-delete"),
    ...
    path(
        "getslots/<int:event_id>/", views.GetEventSlots.as_view(), name="getEventSlotsInHome"
    ),
    path(
