...
urlpatterns = [
    path(
        "api/token/", MyServicerTokenObtainPairView.as_view(), name="token_obtain_pair"
    ),  # For sellers (renters)
    ...
    path(
        "servicer/unblock/<int:servicer_id>/",
        UnblockServicerView.as_view(),
        name="unblock_Servicer",
    ),
]
